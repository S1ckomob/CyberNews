...
const PAGES = [
  ...
  { name: "Zero-Days", href: "/intelligence?view=zero-day", icon: Bug },
  { name: "Ransomware", href: "/intelligence?view=ransomware", icon: Lock },
  { name: "Firewalls & Network", href: "/intelligence?view=firewall", icon: Shield },
  ...
  { name: "Dark Web Monitoring", href: "/intelligence?view=dark-web", icon: Eye },
