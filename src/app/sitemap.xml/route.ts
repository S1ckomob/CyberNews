...
const STATIC_PAGES = [
  ...
  { path: "/cve", priority: "0.8", changefreq: "hourly" },
  { path: "/dark-web", priority: "0.8", changefreq: "hourly" },
  { path: "/blogs", priority: "0.8", changefreq: "hourly" },
  { path: "/threat-actors", priority: "0.8", changefreq: "daily" },
  { path: "/executive", priority: "0.7", changefreq: "daily" },
  { path: "/trends", priority: "0.7", changefreq: "daily" },
  { path: "/map", priority: "0.6", changefreq: "daily" },
  { path: "/attack-surface", priority: "0.6", changefreq: "weekly" },
